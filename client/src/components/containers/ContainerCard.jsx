...
const ContainerCard = ({ container, onCheckUpdate, onUpdate, onToggleExclusion, bulkStatus }) => {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-12 gap-3 md:gap-4 px-4 py-3">
      ...
      <div className="col-span-3 text-xs text-slate-500 dark:text-slate-400 flex items-center">
        {createdDisplay}
      </div>

      <div className="col-span-2 text-xs flex flex-wrap gap-2 items-center text-slate-600 dark:text-slate-300">
      ...
      <div className="col-span-3 flex items-center justify-end gap-3 text-xs md:text-sm">
