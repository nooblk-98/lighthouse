...
const ContainerCard = ({ container, onCheckUpdate, onUpdate, onToggleExclusion, bulkStatus }) => {
  ...
  return (
    <div className="flex flex-col md:grid md:grid-cols-12 md:items-center gap-3 md:gap-4 px-4 py-3">
      ...
      <div className="col-span-3 text-xs text-slate-500 dark:text-slate-400 flex items-center justify-center text-center whitespace-nowrap">
        <span className="block w-full">{createdDisplay}</span>
      </div>

      <div className="col-span-2 text-xs flex flex-nowrap gap-2 items-center justify-center text-slate-600 dark:text-slate-300 text-center">
      ...
      <div className="col-span-3 flex items-center justify-center gap-3 text-xs md:text-sm whitespace-nowrap">
